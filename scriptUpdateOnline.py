...
files=['https://gitlab.com/Fidelus/worldbossdata/-/raw/master/dataAzuregos.csv',
       'https://gitlab.com/Fidelus/worldbossdata/-/raw/master/dataKazzak.csv']
col_name="KillTime"
layer_col_name="Layer"

        
def getDataframe(url,datetime_col_name):
    response = requests.get(url)
    file_object = io.StringIO(response.content.decode('utf-8'))
    return pd.read_csv(file_object, parse_dates=[datetime_col_name])
...
if __name__=="__main__":
	...
	for file in files:
	    ...
	    if file=='https://gitlab.com/Fidelus/worldbossdata/-/raw/master/dataAzuregos.csv':
	        bossName="Azuregos"
	    elif file=='https://gitlab.com/Fidelus/worldbossdata/-/raw/master/dataKazzak.csv':
	        bossName="Kazzak"
	    else:
	...
	with open("dataonlite.json","w") as json_file:
